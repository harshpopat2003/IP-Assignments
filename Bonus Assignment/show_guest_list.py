    ...
    with open("guest_list.csv","r") as f:
        ...
        for row in gst:
            if row==[]:
                ...
                label11.pack()              
                label12=Label(second_frame,text="-------------------------------------------------------------------------",font="times 15 bold")
                label12.pack()
...
label1=Label(second_frame,text="DISPLAY ALL GUEST LIST ",font="Times 20 bold")
label1.pack()

button1=Button(second_frame,text="DISPLAY ALL",font="Courier 20 bold",command=guest_staying)
button1.pack()
